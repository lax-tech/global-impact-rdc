...
function HorizontalLinearStepper() {
  ...
  const handleSubmit = (e) => {
    ...
    axiosInstance
    .post(`business_api/profil/`, formData,{
      headers: {
    ...
    .then((res) => {
      ...
      navigate('/dashboard/business/home', { replace: true });
    }).catch((res) => {
  ...
  return (
    ...
    >
      <h3>Créer un profil business</h3>
      <Grid container spacing={3} justifyContent='center'>
      <Grid item xs={12} sm={ 6} md={6} >
            <TextField
              fullWidth
              label="Nom de votre profil business"
              name="name"
              />
              
          <FormControl fullWidth>
        <InputLabel id="demo-simple-select-label">Domaine</InputLabel>
        <Select
